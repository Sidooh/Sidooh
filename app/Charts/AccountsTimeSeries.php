...
class AccountsTimeSeries extends BaseChart
{
    /**
     ...
     * name will be used.
     */
    public ?string $routeName = 'time-series.accounts';
    ...
    public function handler(Request $request): Chartisan
    {
        ...
        return Chartisan::build()->labels($data['labels'])->dataset('Accounts', $data['datasets']);
    }
}
