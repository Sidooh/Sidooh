...
use App\Helpers\Safaricom\MpesaApiRequestException;
use App\Helpers\Safaricom\MpesaClient;
use Illuminate\Support\Str;

class STK extends MpesaClient
{
    /**
     ...
     * the Safaricom Lipa Na Mpesa Online API.
     *
     * @var string
     */
    ...
    {
        parent::__construct();
        $this->shortCode = config('mpesa.stk_push.short_code');
        $this->passKey = config('mpesa.stk_push.pass_key');
        $this->callbackURL = $this->setUrl(config('mpesa.stk_push.callback_url'));
    }
