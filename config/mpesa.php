...
return [
   ...
   | The package needs this to make requests to the Safaricom APIs.
   |
   */
    ...
    */
    ...
    'initiator' => [
        'name' => env('MPESA_INITIATOR_NAME', 'Sidooh'),
    ...
    */
    ...
    'stk_push' => [
        ...
        'callback_url' => 'payments.mpesa.stk.callback',
        'pass_key' => env('MPESA_STK_PASS_KEY', ''),
    ],
