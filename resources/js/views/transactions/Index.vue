...
export default {
    ...
    computed: {
        ...
        totalAmount() {
            return _.sum(this.data.map(a => a.amount))
        },
        totalAmountToday() {
            return _.sum(this.data.filter(item => this.isToday(new Date(item.created_at))).map(a => a.amount))
        },
        totalAmountThisMonth() {
            return _.sum(this.data.filter(item => this.isThisMonth(new Date(item.created_at))).map(a => a.amount))
        },
