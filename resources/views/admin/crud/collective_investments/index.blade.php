        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-sm table-striped fs--1 mb-0">
                    ...
                    @foreach($collectiveInvestments as $collectiveInvestment)
                        ...
                        <tr class="btn-reveal-trigger">
                            ...
                            <td class="joined align-middle py-2">{{ local_date($collectiveInvestment->maturity_date, 'd/m/Y H:i') }}</td>
                            <td class="joined align-middle py-2">{{ local_date($collectiveInvestment->created_at, 'd/m/Y H:i') }}</td>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end border py-0"
                                        ...
                                        <div class="bg-white py-2">
                                            <a class="dropdown-item"
                                               href="{{ route('admin.collective-investments.sub-investments', $collectiveInvestment) }}">View
                                                Sub
                                                Investments</a>
                                        </div>
                                    </div>
