...
@section('content')
    ...
    <div class="card mb-3" id="customersTable"
         data-list='{"valueNames":["account","amount","interest","created","updated"],"page":10,"pagination":true}'>
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Sub Investments</h5>
                </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-sm table-striped fs--1 mb-0">
                    ...
                    @foreach($subInvestments as $subInvestment)
                        ...
                        <tr class="btn-reveal-trigger">
                            ...
                            <td class="phone align-middle white-space-nowrap py-2">
                                ...
                                <a href="{{ route('admin.accounts.show', $subInvestment->account ) }}">{{ $subInvestment->account->phone }}</a>

                                @if($subInvestment->account->user)
                                    <a href="{{ route('admin.users.show', $subInvestment->account->user) }}">
                                        <div class="d-flex d-flex align-items-center">
                                            <div class="flex-1">
                                                <h5 class="mb-0 fs--1">{{ $subInvestment->account->user->name }}</h5>
                                            </div>
                                        </div>
                                    </a>
                                @endif
                            ...
                            <td class="joined align-middle py-2">{{ local_date($subInvestment->updated_at, 'd/m/Y H:i') }}</td>
