    ...
    <div class="modal-dialog modal-dialog-vertical" role="document">
        <div class="modal-content border-0 vh-100 scrollbar-overlay">
            ...
            <div class="modal-body px-card" id="themeController">
                ...
                {{--                                                               src="{{ asset('img/icons/left-arrow-from-left.svg') }}"--}}
                {{--                                                               width="20" alt=""/>--}}
                {{--                        <div class="flex-1">--}}
                ...
                <hr/>
                {{--                <div class="d-flex align-items-start"><img class="me-2" src="{{ asset('img/icons/paragraph.svg') }}"--}}
                {{--                                                           width="20" alt=""/>--}}
                {{--                    <div class="flex-1">--}}
                ...
                {{--                            <div class="form-check form-check-inline"><input class="form-check-input"--}}
                {{--                                                                             id="option-navbar-top" type="radio"--}}
